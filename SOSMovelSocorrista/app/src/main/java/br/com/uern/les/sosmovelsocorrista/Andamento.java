...
public class Andamento extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageButton btnAndRegulacao;
    ImageButton btnAndSinaisVitais;
    ImageButton btnAndAndamento;
    ImageButton btnAndEquipe;
    ImageButton btnAndMapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAndRegulacao = findViewById(R.id.btnAndRegulacao);
        btnAndSinaisVitais = findViewById(R.id.btnAndSinaisVitais);
        btnAndAndamento = findViewById(R.id.btnAndAndamento);
        btnAndEquipe = findViewById(R.id.btnAndEquipe);
        btnAndMapa = findViewById(R.id.btnAndMapa);
