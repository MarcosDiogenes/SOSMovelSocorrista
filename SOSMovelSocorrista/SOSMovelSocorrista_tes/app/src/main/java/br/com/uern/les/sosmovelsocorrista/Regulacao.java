...
public class Regulacao extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btnRegRegulacao = findViewById(R.id.btnRegRegulacao);
        ImageButton btnRegSinaisVitais = findViewById(R.id.btnRegSinaisVitais);
        ImageButton btnRegAndamento = findViewById(R.id.btnRegAndamento);
        ImageButton btnRegEquipe = findViewById(R.id.btnRegEquipe);
        ImageButton btnRegMapa = findViewById(R.id.btnRegMapa);
